...
export default function MemberNotesScreen({ navigation }: any) {
  ...
  const openEditForm = (note: SermonNote) => {
  ...
  const renderNoteCard = ({ item }: { item: SermonNote }) => (
    <View style={[styles.noteCard, { backgroundColor: isDark ? '#1e293b' : '#fff', borderColor: isDark ? '#334155' : '#e2e8f0' }]}>
      <TouchableOpacity 
      ...
      <View style={styles.cardActionsRow}>
        <TouchableOpacity style={styles.actionBtn} onPress={() => openEditForm(item)}>
          ...
          <Text style={[styles.actionBtnTxt, { color: '#1a2d5a' }]}>Edit</Text>
        </TouchableOpacity>
          ...
          <View style={[styles.modalCard, { backgroundColor: isDark ? '#1e293b' : '#fff' }]}>
            ...
            <View style={styles.modalHeader}>
              <Text style={[styles.modalTitle, { color: isDark ? '#fff' : '#0f172a' }]}>
                {editingNoteId ? 'Edit Sermon Note' : 'Create New Sermon Note'}
              </Text>
              <TouchableOpacity 
